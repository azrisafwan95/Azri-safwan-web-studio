import { $_ as CopyPasteContextType, $r as FieldPresenceData, Bf as TasksNavigationContextValue, Cy as StudioColorScheme, Dy as AddonDatasetContextValue, Fc as ReferenceInputOptions, Fn as PortableTextMemberItem, Fy as WorkspacesContextValue, Hu as DivergenceNavigator, It as DocumentFieldAction$1, Iv as SearchContextValue, Mh as EventsStore, NC as MetadataWrapper, O_ as NavbarContextValue, P_ as StudioAnnouncementsContextValue, Qg as CommentsEnabledContextValue, Qy as CommentsSelectedPathContextValue, Rf as TasksUpsellContextValue, T_ as UpsellDialogViewedInfo, Tg as ConsentStatus, Ty as StudioThemeColorSchemeKey, Uf as TasksEnabledContextValue, Uy as VisibleWorkspacesContextValue, Vf as MentionUserContextValue, Vt as DocumentFieldActionNode$1, Wc as FormCallbacksValue, Wu as ParseError, Xg as CommentsOnboardingContextValue, Xy as RouterHistory, _t as Workspace, a_ as CommentInputContextValue, ag as UserColorManager, bC as ConnectorContextValue, cC as ChangeIndicatorTrackerContextValue, cr as FormBuilderContextValue, cw as PerspectiveContextValue, dC as TrackerContextGetSnapshot, d_ as UpsellData, e_ as CommentsContextValue, ei as FormNodePresence, em as DocumentChangeContextInstance, eu as PreviewCardContextValue, fC as TrackerContextStore, fi as ResourceCache, ft as Source$1, gp as DocumentActionProps, hl as ZIndexContextValue, ic as EnhancedObjectDialogContextValue, ju as ReleasesUpsellContextValue, kb as CommentsAuthoringPathContextValue, lb as CommentIntentGetter, ls as FieldCommentsProps, nx as Locale, rr as VirtualizerScrollInstance, t as ActiveWorkspaceMatcherContextValue, ts as PortableTextMarker, u_ as CommentsUpsellContextValue, up as DocumentActionDescription, xp as SchedulesContextValue, yg as TagValue, yr as FormValueContextValue, zf as TasksContextValue } from "./_chunks-dts/ActiveWorkspaceMatcherContext.js";
 ...
 * @internal
 */
declare const CommentInputContext: import("react").Context<CommentInputContextValue | null>;
/**
 * @beta
 * @hidden
 */
declare const CommentsAuthoringPathContext: import("react").Context<CommentsAuthoringPathContextValue | null>;
/**
 * @internal
 */
 ...
 * @internal
 */
declare const CommentsIntentContext: import("react").Context<CommentIntentGetter | undefined>;
/**
 * @internal
 */
declare const CommentsOnboardingContext: import("react").Context<CommentsOnboardingContextValue | null>;
/**
 * @internal
 */
declare const CommentsSelectedPathContext: import("react").Context<CommentsSelectedPathContextValue | null>;
/**
 * @internal
 */
declare const CommentsUpsellContext: import("react").Context<CommentsUpsellContextValue | null>;
/**
 * @beta
 * @hidden
 */
