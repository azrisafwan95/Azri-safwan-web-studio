...
import { useTasksEnabled, useTasksNavigation, useTranslation, tasksLocaleNamespace } from "./index2.js";
import "history";
import "rxjs";
...
const EMPTY_ARRAY = [], TasksToolbar = (t0) => {
  const $ = c(8), {
    ...
    t
  } = useTranslation(tasksLocaleNamespace);
  let t1;
  ...
  let t3;
  return $[4] !== isOpen || $[5] !== onClick || $[6] !== t2 ? (t3 = /* @__PURE__ */ jsx(Button, { tooltipProps: t2, icon: CheckmarkCircleIcon, mode: "bleed", onClick, selected: isOpen, "data-testid": "tasks-toolbar" }), $[4] = isOpen, $[5] = onClick, $[6] = t2, $[7] = t3) : t3 = $[7], t3;
};
function TasksStudioNavbarInner(props) {
  ...
  let t2;
  $[4] !== handleClick || $[5] !== isOpen ? (t2 = () => /* @__PURE__ */ jsx(TasksToolbar, { onClick: handleClick, isOpen }), $[4] = handleClick, $[5] = isOpen, $[6] = t2) : t2 = $[6];
  const renderTasksNav = t2, t3 = props?.__internal_actions || EMPTY_ARRAY;
  let t4;
  $[7] !== renderTasksNav ? (t4 = {
    location: "topbar",
    name: "tasks-topbar",
  ...
  let t7;
  $[15] !== t3 || $[16] !== t4 || $[17] !== t6 ? (t7 = [...t3, t4, t6], $[15] = t3, $[16] = t4, $[17] = t6, $[18] = t7) : t7 = $[18];
  const actions = t7;
  let t8;
...
function TasksStudioNavbar(props) {
  ...
  let t0;
  return $[2] !== props ? (t0 = /* @__PURE__ */ jsx(TasksStudioNavbarInner, { ...props }), $[2] = props, $[3] = t0) : t0 = $[3], t0;
}
export {
  TasksStudioNavbar
};
//# sourceMappingURL=TasksStudioNavbar.js.map
