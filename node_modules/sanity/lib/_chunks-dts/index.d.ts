 ...
 * @internal
 */
declare const Pane: import("react").ForwardRefExoticComponent<Omit<PaneProps & Omit<CardProps, "as" | "overflow"> & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "hidden" | "id" | "style">, "ref"> & import("react").RefAttributes<HTMLDivElement>>;
 ...
 * @internal
 */
declare const PaneContent: import("react").ForwardRefExoticComponent<PaneContentProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & import("react").RefAttributes<HTMLDivElement>>;
/**
 *
 * @hidden
...
declare const structureLocaleStrings: {
  ...
  'menu-items.layout.detailed-view': string; /** The menu item title that restores the structure-configured default layout */
  'menu-items.layout.restore-default': string; /** Tooltip shown when the restore-default layout item is disabled (default already in use) */
  'menu-items.layout.restore-default.disabled-reason': string; /** The menu item title to Sort by Created */
  'menu-items.sort-by.created': string; /** The menu item title to Sort by Last Edited */
  'menu-items.sort-by.last-edited': string; /** The menu item title that restores the structure-configured default sort order */
  'menu-items.sort-by.restore-default': string; /** Tooltip shown when the restore-default sort item is disabled (default already in use) */
  'menu-items.sort-by.restore-default.disabled-reason': string; /** The link text of the no document type screen that appears directly below the subtitle */
  ...
  'panes.document-list-pane.search-input.placeholder': string; /** The aria-label for the sort-order control shown beneath the document list search input */
  'panes.document-list-pane.search-ordering.aria-label': string; /** The label for the sort-order control beneath the search input, summarising the applied ordering (e.g. "Sorted by relevance") */
  'panes.document-list-pane.search-ordering.label': string; /** The label for the relevance (best match) option in the document list search sort-order control */
  'panes.document-list-pane.search-ordering.relevance': string; /** The sort-order control summary shown when results are ranked by relevance */
  'panes.document-list-pane.search-ordering.summary-relevance': string; /** The tooltip text shown when a sort menu item references fields not present in the current schema */
  'panes.document-list-pane.sort-order.disabled-reason': string; /** The summary title when displaying an error for a document operation result */
...
export { usePaneRouter as C, ConfirmDeleteDialogContainer as D, Pane as E, ConfirmDeleteDialogProps as O, IncomingReferencesOptions as S, PaneContent as T, structureLocaleNamespace as _, structureTool as a, defineIncomingReferenceDecoration as b, PaneContainer as c, UseDocumentTitle as d, useDocumentTitle as f, DocumentPaneProviderProps as g, usePaneOptions as h, StructureToolProviderProps as i, BaseStructureToolPaneProps as k, useDocumentPane as l, DocumentPane as m, useStructureTool as n, ORDER_BY_IDS_PARAM_FIELD as o, DocumentPaneProviderWrapper as p, StructureToolProvider as r, DocumentListPaneProps as s, PaneRouterContext as t, DocumentInspectorHeader as u, StructureLocaleResourceKeys as v, PaneLayout as w, IncomingReferenceAction as x, isIncomingReferenceCreation as y };