...
import { OWN_PROPS_NAME, Rule, Schema } from "./_chunks-es/Schema.js";
import { ALL_FIELDS_GROUP_NAME, DEFAULT_MAX_FIELD_DEPTH, resolveSearchConfig, resolveSearchConfigForBaseFieldPaths } from "./_chunks-es/Schema.js";
...
function maybeBlockMarks(schemaType) {
  if (schemaType.jsonType !== "object" || !isType$1(schemaType, "block"))
    return;
  const spanType = schemaType.fields?.find(
    (field) => field.name === "children"
  )?.type?.of?.find((memberType) => memberType.name === "span");
