 ...
 */ export function shouldWarnDashboardFlagIgnored(cliConfig, loadInDashboard) {
...
export class DevCommand extends SanityCommand {
    ...
    async run() {
        ...
        if (shouldWarnDashboardFlagIgnored(cliConfig, flags['load-in-dashboard'])) {
            this.output.warn('Ignoring --load-in-dashboard: workbench apps do not load in the Sanity dashboard');
        }
