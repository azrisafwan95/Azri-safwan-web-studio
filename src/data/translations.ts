export const translations = {
  en: {
    ...
    portfolio: {
      title: 'Selected', titleGold: 'Portfolio',
      desc: 'High-quality results that have helped entrepreneurs boost their digital presence.'
    },
    pricing: {
    ...
    about: {
      ...
      story: 'I am Azri Safwan. By day, I drive trucks; by night, I work at Texas Chicken. In between, I built a passion for web development.',
      vision: 'I believe in hard work. If I can manage a 10-ton truck, I can manage your web project with full dedication. I build sites that generate sales.',
  ...
  ms: {
    ...
    hero: {
      ...
      title: 'Tukarkan Bisnes Anda',
      titleGold: 'Kepada Digital',
    ...
    portfolio: {
      title: 'Portfolio', titleGold: 'Terpilih',
      desc: 'Hasil kerja berkualiti tinggi yang telah membantu usahawan melonjakkan bisnes mereka.'
    },
    pricing: {
    ...
    about: {
      ...
      story: 'Saya Azri Safwan. Siang saya memandu lori, malam saya bekerja di Texas Chicken. Di celah-celah kesibukan itu, saya membina minat dalam web dev.',
      vision: 'Saya percaya kerja keras adalah kunci. Jika saya boleh menguruskan lori 10 tan, saya boleh menguruskan projek anda dengan penuh dedikasi.',
